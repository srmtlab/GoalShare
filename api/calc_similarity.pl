...
my $WEIGHT_BOW = 0.5;              # weight of BoW (Bag-of-Words)
my $WEIGHT_BOT = 1 - $WEIGHT_BOW;  # weight of BoT (Bag-of-Topics)
...
my $DECAY_SUPER = 0.8;  # decay ratio for super-goals
my $DECAY_SUB = 0.4;    # decay ratio for sub-goals
