...
my $SIM_THRESHOLD = 0.01; # threshold of the similarity for linking goals 
...
my $graph_uri = "http://collab.open-opinion.org";
#my $graph_uri_expresult = "http://collab.open-opinion.org/testa";
...
<$goal2_uri> schema:isSimilarTo <$goal1_uri>.";
    ...
    # insert_n3($n3_link, $graph_uri_expresult);
    ...
    # insert_n3($n3_aninfo1, $graph_uri_expresult);
    ...
    # insert_n3($n3_aninfo2, $graph_uri_expresult);
